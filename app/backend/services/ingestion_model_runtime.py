...
async def extract_load_order_with_model(
    ...
    system_prompt = (
        ...
        "- Date conversion rules (CRITICAL - follow exactly):\n"
        "  * '15/06 a las 08:30 h' -> '2026-06-15T08:30:00'\n"
        "  * 'Jueves 18/06 a partir de las 15:00 h' -> '2026-06-18T15:00:00'\n"
        "  * 'Viernes 19/06 por la mañana' -> '2026-06-19T08:00:00' (assume 08:00 for 'morning/mañana')\n"
        "  * 'Viernes 19/06 por la tarde' -> '2026-06-19T16:00:00' (assume 16:00 for 'afternoon/tarde')\n"
